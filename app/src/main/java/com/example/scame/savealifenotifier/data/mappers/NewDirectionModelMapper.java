...
public class NewDirectionModelMapper {

    private static final int FIRST_ROUTE = 0;

    private static final int PRECISION = 5;

    public NewDirectionModel convert(DirectionEntity directionEntity) {
        ...
        NewDirectionModel directionModel = new NewDirectionModel();
